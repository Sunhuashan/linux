		       ...
		       struct tee_param *param)
{
	...
	printk("my error msg: Running at optee_open_session()");
	...
	printk("my error msg: Finished phrase arg and params");
	...
	printk("my error msg: Finished add any params in shm");
	...
	printk("my error msg: Finished optee_do_call_with_arg(), arg->ret = 0x%x", msg_arg->ret);
